  ...
  const handleKeyDown = (e: KeyboardEvent) => {
    ...
    if (key === " ") {
      ...
      if (
        ...
        router.push(`/local/frank/episode_${nextEpisodeId}`);
      }
    }
  };
      ...
      >
        ...
        <div className="flex items-center justify-between mb-4 pb-4 border-b border-slate-700/50">
          <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">FRANK Robot</h1>
              <p className="text-xs text-slate-400">Episode {episodeId}</p>
            </div>
          </Link>
          <nav className="flex items-center gap-4">
            ...
            <Link href="/comparison" className="text-slate-400 hover:text-white transition-colors">
              Comparison
            </Link>
          </nav>
        </div>
